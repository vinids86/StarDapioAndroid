...
public class CustomMarkerClusteringDemoActivity extends BaseDemoActivity
	...
	protected void startDemo() {
		...
		getMap().moveCamera(
				CameraUpdateFactory.newLatLngZoom(new LatLng(51.503186,
						-0.126446), 9.5f));
		mClusterManager2 = new ClusterManager<MyItem>(this, getMap());
        // getMap().setOnCameraChangeListener(mClusterManager2);
        composite.registerCameraChangeListener(mClusterManager2);
		...
		composite.registerCameraChangeListener(mClusterManager);
		...
		getMap().setOnCameraChangeListener(composite);
		addItems();
    ...
    private void readItems() throws JSONException {
        ...
        mClusterManager2.addItems(items);
    }
